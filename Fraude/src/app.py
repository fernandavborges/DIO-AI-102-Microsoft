...
def configure_interface():
    st.title("Upload de Arquivos DIO - Fraude")
    ...
    if uploaded_file is not None:
        ...
        if blob_url:
            ...
            credit_card_info = analyse_credit_card(blob_url)

            show_image_and_validation(blob_url, credit_card_info)

        else:
            st.write(f"Erro ao enviar o aquivo {fileName} para Azure Blob Storage")
